...
import { Chart, Title, LinearScale, BarController, CategoryScale, LineController, PointElement, Tooltip, TimeScale, TimeSeriesScale, LineElement } from 'chart.js'; // Dodaj TimeScale i TimeSeriesScale
